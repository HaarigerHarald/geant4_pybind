...
{
   py::class_<G4SDChargedFilter, G4VSDFilter, std::unique_ptr<G4SDChargedFilter, py::nodelete>>(m, "G4SDChargedFilter")

      .def(py::init<G4String>(), py::arg("name"))
      .def("Accept", &G4SDChargedFilter::Accept);

   py::class_<G4SDKineticEnergyFilter, G4VSDFilter, std::unique_ptr<G4SDKineticEnergyFilter, py::nodelete>>(
      m, "G4SDKineticEnergyFilter")
   ...
   py::class_<G4SDNeutralFilter, G4VSDFilter, std::unique_ptr<G4SDNeutralFilter, py::nodelete>>(m, "G4SDNeutralFilter")

      .def(py::init<G4String>(), py::arg("name"))
      .def("Accept", &G4SDNeutralFilter::Accept);

   py::class_<G4SDParticleFilter, G4VSDFilter, std::unique_ptr<G4SDParticleFilter, py::nodelete>>(m,
                                                                                                  "G4SDParticleFilter")
   ...
   py::class_<G4SDParticleWithEnergyFilter, G4VSDFilter, std::unique_ptr<G4SDParticleWithEnergyFilter, py::nodelete>>(
      m, "G4SDParticleWithEnergyFilter")
