...
{
   py::class_<G4LogicalVolume, std::unique_ptr<G4LogicalVolume, py::nodelete>>(m, "G4LogicalVolume",
      ...
      .def("GetSolid", py::overload_cast<>(&G4LogicalVolume::GetSolid, py::const_),
      ...
      .def("GetMasterFieldManager", &G4LogicalVolume::GetMasterFieldManager,
           py::return_value_policy::reference_internal)
   ...
   py::class_<G4LogicalVolumeStore, std::unique_ptr<G4LogicalVolumeStore, py::nodelete>>(m, "G4LogicalVolumeStore")
