...
void export_G4PhantomParameterisation(py::module &m)
{
   py::class_<G4PhantomParameterisation, PyG4PhantomParameterisation, G4VPVParameterisation>(
      ...
      .def("SetNoVoxel", &G4PhantomParameterisation::SetNoVoxel, py::arg("nx"), py::arg("ny"), py::arg("nz"))
      ...
      .def("GetNoVoxelX", &G4PhantomParameterisation::GetNoVoxelX)
      .def("GetNoVoxelY", &G4PhantomParameterisation::GetNoVoxelY)
      .def("GetNoVoxelZ", &G4PhantomParameterisation::GetNoVoxelZ)
      .def("GetNoVoxel", &G4PhantomParameterisation::GetNoVoxel)
