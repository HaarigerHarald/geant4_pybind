...
{
PYBIND11_OVERRIDE(void, G4PhysicsVector, Initialise, );
}
};
...
//.def("FillSecondDerivatives", &G4PhysicsVector::FillSecondDerivatives, py::arg("arg0") = Base, py::arg("dir1") = 0., py::arg("dir2") = 0.)
...
.def("GetValue", [] (const G4PhysicsVector& self, const G4double energy,  G4bool & isOutRange) { return std::make_tuple(self.GetValue(energy, isOutRange) , isOutRange); } , py::arg("energy"), py::arg("isOutRange"))
...
.def("Value", [] (const G4PhysicsVector& self, const G4double energy,  size_t & lastidx) { return std::make_tuple(self.Value(energy, lastidx) , lastidx); } , py::arg("energy"), py::arg("lastidx"))
