...
{
PYBIND11_OVERRIDE(void, G4PhysicsFreeVector, Initialise, );
}
};
...
.def(py::init<size_t, G4double, G4double, G4bool>(), py::arg("length"), py::arg("emin"), py::arg("emax"), py::arg("spline") = false)

.def(py::init<const std::vector<double> &, const std::vector<double> &, G4bool>(), py::arg("energies"), py::arg("values"), py::arg("spline") = false)

.def(py::init<const G4double *, const G4double *, size_t, G4bool>(), py::arg("energies"), py::arg("values"), py::arg("length"), py::arg("spline") = false)
