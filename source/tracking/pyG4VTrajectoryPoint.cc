...
class TRAMPOLINE_NAME(G4VTrajectoryPoint) : public G4VTrajectoryPoint {
...
{
   py::class_<G4VTrajectoryPoint, TRAMPOLINE_NAME(G4VTrajectoryPoint), std::unique_ptr<G4VTrajectoryPoint>>(
      m, "G4VTrajectoryPoint")
      .def(py::init<>())
